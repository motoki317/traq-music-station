...
public class TrackScheduler extends AudioEventAdapter {
    ...
    public void onTrackStart(AudioPlayer player, AudioTrack track) {
        ...
        String msg = formatNowPlaying(track, user, setting, showPosition);

        this.gateway.sendMessage(msg);
    }

    private void sendEmptyQueueMessage() {
        this.gateway.sendMessage("Queue ended, please enqueue some new music, or the bot will leave automatically after some time.");
    ...
    public void onTrackStuck(AudioPlayer player, AudioTrack track, long thresholdMs) {
        this.gateway.sendMessage("Error: Player timed out.");
    }
}
